 ...
 */
async function generate(ctx: Imbed, options: IOptions): Promise<any> {
    try {
 ...
 */
function filters(ctx: Imbed, exp: any, data: any): boolean {
 ...
 */
function getOptions(templatePath: string): any {
 ...
 * @param {arry} files
 */
function render(files: string[], source: string, options: any): any {
    const fileTree = {}
